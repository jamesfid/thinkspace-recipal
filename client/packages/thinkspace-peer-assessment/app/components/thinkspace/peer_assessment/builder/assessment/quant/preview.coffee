...
import quant_item from 'thinkspace-peer-assessment/components/peer_assessment/builder/assessment/quant/item'
...
export default base.extend
  ...
  # ### Components
  c_quant_settings: ns.to_p 'peer_assessment', 'builder', 'assessment', 'quant', 'settings'
