...
export default ember.ArrayProxy.extend
  ...
  total_records: ember.computed.reads 'meta.total'
  ...
  add_to_all_content: (content) ->
    ...
    content.forEach (record) => 
      all_content.pushObject(record) unless all_content.contains(record)
  ...
  set_content_from_payload: (payload) ->
    ...
    records = ajax.normalize_and_push_payload type, payload, skip_ns: true
    @set_content records

  set_content_from_type_and_payload: (type, payload) ->
