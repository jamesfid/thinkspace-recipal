...
Gem::Specification.new do |s|
  ...
  s.name         = 'thinkspace-observation-list'
  s.version      = version
  s.authors      = ['Iowa State University/Sixth Edge']
  s.email        = ['james@sixthedge.com']
  s.homepage     = 'http://www.thinkspace.org'
  s.summary      = 'Thinkspace Observation List'
  s.description  = 'Thinkspace Observation List engine'
  s.license      = %q{MIT}
  s.require_path = ['lib']

  s.files  = Dir['README.md', 'LICENSE.md']
  s.files += Dir['thinkspace-observation-list.gemspec']
