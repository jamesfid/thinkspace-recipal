    ...
    module Api
      class AssignmentsController < ::Totem::Settings.class.thinkspace.authorization_api_controller
        ...
        def assignment_phase_states
          ...
          controller_view_json(phase_states)
        end
        ...
        def gradebook_users
          ...
          hash      = controller_as_json(space)
          space_key = space.class.name.underscore
          hash[space_key.pluralize] = [ hash[space_key] ]
          hash.delete(space_key)
