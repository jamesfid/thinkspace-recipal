      ...
      module Admin
        class PhasesController < ::Totem::Settings.class.thinkspace.authorization_api_controller
          ...
          def update
            ...
            @phase.team_category_id = params_root[:team_category_id] if params_root.has_key?(:team_category_id) && @builder_abilities[:team_category]
            @phase.default_state    = (params_root[:default_state] || 'unlocked') if params_root.has_key?(:default_state) && @builder_abilities[:default_state]
            update_timetable
            update_phase_team_set if params_root.has_key?(:team_set_id) && @builder_abilities[:team_set]
