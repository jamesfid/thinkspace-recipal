...
Gem::Specification.new do |s|
  ...
  s.name         = 'thinkspace-diagnostic-path'
  s.version      = version
  s.authors      = ['Iowa State University/Sixth Edge']
  s.email        = ['james@sixthedge.com']
  s.homepage     = 'http://www.thinkspace.org'
  s.summary      = 'Thinkspace Diagnostic Path'
  s.description  = 'Thinkspace Diagnostic Path engine'
  s.license      = %q{MIT}
  s.require_path = ['lib']

  s.files  = Dir['README.md', 'LICENSE.md']
  s.files += Dir['thinkspace-tool-diagnostic-path.gemspec']
