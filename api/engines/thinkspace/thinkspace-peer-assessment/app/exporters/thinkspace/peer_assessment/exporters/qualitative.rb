module Thinkspace; module PeerAssessment; module Exporters; class Qualitative < Thinkspace::PeerAssessment::Exporters::Assessment
  ...
  def process_user(user)
    ...
    reviews = reviews.joins("INNER JOIN thinkspace_common_users ON thinkspace_common_users.id = thinkspace_peer_assessment_reviews.reviewable_id").order('thinkspace_common_users.last_name')
    rows    = []
  ...
  def get_assessment_labels
    items = @assessment.qualitative_items
