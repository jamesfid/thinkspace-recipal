module Thinkspace::Test; module PhaseActions; module Ownerables
...
included do
  ...
  def team_1; @_team_1 ||= get_team(:phase_actions_team_1); end
  def team_2; @_team_2 ||= get_team(:phase_actions_team_2); end
  def team_3; @_team_3 ||= get_team(:phase_actions_team_3); end
