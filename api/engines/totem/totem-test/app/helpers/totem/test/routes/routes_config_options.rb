module Totem::Test; module Routes; class RoutesConfigOptions
  ...
  def engine_match?(name); config_match?(name, options[:only_engines], options[:except_engines], get_platform_name.to_sym); end
