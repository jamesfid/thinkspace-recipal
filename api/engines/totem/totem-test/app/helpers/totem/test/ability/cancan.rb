module Totem::Test; module Ability; module Cancan
extend ActiveSupport::Concern

  class_methods do
    def alias_read_actions; [:read, :index, :show, :select, :view]; end
    def ability_class; @_ability_class ||= constantize_platform_class('Authorization::Ability'); end
  ...
  included do
    ...
    def ability_class;       self.class.ability_class; end
    def ability_error_class; @_ability_error_class ||= constantize_platform_class('Authorization::AbilityError'); end
